...
public class SentenceWordCountTopology {
   ...
   */
   ...
   static class SplitSentenceBolt extends BaseRichBolt {
     Random _rand;     // To output tuples from this bolt to the next stage bolts, if any
     ...
     public void execute(Tuple tuple)
     {
       ...
       String sentencetemp = tuple.getString(0);
       String delims = "[ .,?!]+";
       String words[] = sentencetemp.split(delims);
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    builder.setBolt("count-bolt", new CountBolt(), 15).fieldsGrouping("split-sentence-bolt", new Fields("word"));
